...
#include "IAIAvatarROSCommandGrasp_r.generated.h"
...
class UIAIAVATAR_API UIAIAvatarROSCommandGrasp_r : public UIAIAvatarROSCommandBase
{
	GENERATED_BODY()

public:
	// Sets default values for this component's properties
	UIAIAvatarROSCommandGrasp_r();
